...
export class IntervalRule implements Rule<IntervalRuleType> {
  ...
  constructor(public type: IntervalRuleType, public interval: number, public from: DayParts) {
...
export class DaysRule extends ComponentRule {
  constructor(components: unknown) {
    super(ComponentRuleType.Days, components, isDayInMonth, ({ day, dayFromEnd }) => [
      day,
      -dayFromEnd,
    ]);
  }
...
export class WeeksRule extends ComponentRule {
  constructor(components: unknown) {
    super(ComponentRuleType.Weeks, components, isWeekInMonth, ({ week, weekFromEnd }) => [
      week,
      -weekFromEnd,
    ]);
  }
...
export class OrdinalComponentRule implements Rule<OrdinalComponentRuleType> {
  ...
  constructor(public type: OrdinalComponentRuleType, components: OrdinalArrayConfig) {
    this.components = this.normalizeComponents(components);
  }
